...
const languageModule = (function() {
    ...
    const translations = {
        ...
        'ja-jp': {
            ...
            'orderEntry.searchPlaceholder': 'タオバオID、商品名または注文番号で検索...',
            'orderEntry.search': '検索',
            'orderEntry.add': '注文を追加',
            'orderEntry.serialNumber': '番号',
            'orderEntry.taobaoId': 'タオバオID',
            ...
            'orderEntry.taobaoIdPlaceholder': 'タオバオユーザーIDを入力',
            ...
            'exchange.back': '戻る',
            'exchange.code': '交換コード',
            'exchange.codeDescription': '交換コードを入力してください',
            'exchange.codePlaceholder': '交換コードを入力',
            'exchange.redeem': '交換',
            'exchange.redemptionHistory': '交換履歴',
            'exchange.or': 'または',
            'exchange.points': 'ポイント交換',
            'exchange.pointsDescription': 'タオバオ注文番号を入力してポイントを交換',
            'exchange.orderPlaceholder': 'タオバオ注文番号を入力',
            ...
            'userSettings.point2': 'ポイント2',
            'userSettings.creditPoints': 'クレジットポイント',
            ...
            'userSettings.adjustAvatar': 'アバター調整',
            'userSettings.ccbBinding': 'CCBバインディング情報',
            'userSettings.server': 'サーバー',
            'userSettings.cardNumber': 'カード番号',
            ...
            'settings.cachedEmoji': 'キャッシュ済み絵文字',
            'settings.cachedAudio': 'キャッシュ済み音声',
            'settings.messageImages': 'メッセージ画像',
            ...
            'settings.preloadEmoji': '一般的な絵文字と音声を事前読み込み',
